...
轻透的冷灰玻璃面板常驻桌面，把要做的事留在眼前，同时尽量减少打扰。

<p align="center">
  <img src="docs/screenshot.svg" width="360" alt="keList 白色界面预览">
</p>
...
- **鼠标穿透**：启用后可直接操作清单后方内容，顶部工具按钮仍可点击，并可用快捷键安全恢复
...
- **推荐环境**：Windows 11，可获得更协调的透明窗口与圆角效果
- **处理器架构**：x64
- **运行依赖**：无，自包含版本下载即用
...
在系统托盘中的 keList 图标上右键，勾选 **开机启动** 即可。
